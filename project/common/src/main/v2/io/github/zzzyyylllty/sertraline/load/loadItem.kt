...
fun loadItem(iconfig: Configuration, root: String) : SertralineItem {
    ...
    var customMeta = iconfig.getConfigurationSection(root)?.getValues(false)!! as LinkedHashMap<String, Any?>
    ...
    val item = SertralineMaterial(
        ...
        nbt = nbts,
        extra = config.getMap<String, Any?>("minecraft.extra") as HashMap<String, Any?>,
    )
    ...
    return SertralineItem(
        ...
        sertralineMeta = SertralineMeta(
            ...
            data = config.getMap<String, Any?>("sertraline.data") as HashMap<String, Any?>,

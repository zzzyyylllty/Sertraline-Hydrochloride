...
fun replaceTestTexts(str: String): String {
    ...
    val replaced = str
        .replaceUnrelocated("!top.maplex.arim","!io.github.zzzyyylllty.sertraline.library.arim")
        .replaceUnrelocated("!ink.ptms.um","!io.github.zzzyyylllty.sertraline.library.um")
        .replaceUnrelocated("!com.alibaba", "!io.github.zzzyyylllty.sertraline.library.alibaba")
        .replaceUnrelocated("!kotlinx.serialization", "!kotlinx.serialization170")
        .replaceUnrelocated("!io.github.projectunified.uniitem","!io.github.zzzyyylllty.sertraline.library.uniitem")
        .replaceUnrelocated("!com.fasterxml.jackson","!io.github.zzzyyylllty.sertraline.library.jackson")
        .replaceUnrelocated("!com.mojang.datafixers","!io.github.zzzyyylllty.sertraline.library.datafixers")
        .replaceUnrelocated("!io.netty.handler.codec.http", "!io.github.zzzyyylllty.sertraline.library.http")
        .replaceUnrelocated("!io.netty.handler.codec.rtsp", "!io.github.zzzyyylllty.sertraline.library.rtsp")
        .replaceUnrelocated("!io.netty.handler.codec.spdy", "!io.github.zzzyyylllty.sertraline.library.spdy")
        .replaceUnrelocated("!io.netty.handler.codec.http2", "!io.github.zzzyyylllty.sertraline.library.http2")
